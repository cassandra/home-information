...
Notifier
========
Each Notifier will hold a single HomeBox Notifier.
It is basically a bunch of getters for each access to notifier data.
...
class Notifier(Base):
    def __init__(self, api=None, notifier=None):
        self.api = api
    ...
    def id(self):
        ...
        Returns:
            string: Notifier Id
        """
        return self.notifier['id']
    
    @property
    def name(self):
        """Returns notifier name
        
        Returns:
            string: notifier name
        """
        return self.notifier['name']
    
    @property
    def description(self):
        """Returns notifier description
