...
class EntityEditFormHandler:
    ...
    def create_entity_forms(self, entity, form_data=None):
    ...
    def validate_forms(self, entity_form, property_attributes_formset):
        """
        ...
        """
        return entity_form.is_valid() and property_attributes_formset.is_valid()

    def save_forms(self, entity_form, property_attributes_formset, request, entity):
        """
    ...
    def process_file_deletions(self, request, entity):
    ...
    def process_file_title_updates(self, request, entity):
    ...
    def collect_form_errors(self, entity_form, property_attributes_formset):
    ...
    def create_initial_context(self, entity):
        ...
        """
        entity_form, file_attributes, property_attributes_formset = self.create_entity_forms(entity)
