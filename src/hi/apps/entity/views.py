...
class EntityStatusView( HiModalView, EntityViewMixin ):
    ...
    def get( self,
        ...
        entity_panel_data = build_entity_panel_data( entity_display_data, DisplayContext.MODAL )
        context = {
            'entity_panel_data' : entity_panel_data,
            'panel_trace'       : entity_panel_data.trace if request.GET.get( 'debug_panel' ) else None,
        }
