...
class SimEntityFields:
    ...
    ServiceSimulatorManager through the sim_entity_definition_list() method of the
    ServiceSimulator class (using the SimEntityDefinition class).
    """
    name             : str
...
class SimState:
    ...
    entities fields and values by the ServiceSimulatorManager.
...
class SimEntityDefinition:
    """
    Used by ServiceSimulator instances to define a simulated entity that is
